...
- Docstring. `legacy_credential_check` names the sleep writer and says why a sleep row uses the commit check. Every other door keeps the floor alone.
